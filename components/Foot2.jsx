...
export const Foot2 = () => {
  return (
    <>
        <ul className="flex flex-col gap32 mr-[6rem] lg:mr-32 text-black 
        font-feature-settings font-rubik text-[16px]">
      
      <Link href="/" className="flex gap-4 md:flex-col  m-1 lg:flex-row  
        ">
        <p className="whitespace-nowrap">{FOOTER_LINKS.label}
      ...
      <div className="group inline-block  ">
        <button
          className=" rounded-3xl flex items-center min-w-32">
      ...
      <Link href="#courses" className="flex-row gap-4 md:flex-col  m-1 lg:flex-row">
        <p className="whitespace-nowrap ">{FOOTER_LINKS.link2} 
        <span>
            <svg
      ...
      <Link href="#contact" className="flex gap-4 md:flex-col  m-1 lg:flex-row">
