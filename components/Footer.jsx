          ...
          <div className="flex-col pt-2 items-start justify-center  md:flex-row pb-8">
            ...
            <ul className="inline-flex ">
              <svg
                ...
                fill="none"
              >
                <Link href="https://www.facebook.com/abhishek_patnigere/">
